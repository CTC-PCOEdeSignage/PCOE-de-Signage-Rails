...
RSpec.describe Senders::EventDeclinedEmail, :type => :service do
  ...
  context "when persisted" do
    ...
    it "should send email" do
      expect(EventMailer).to receive(:decline).with(event).and_return(deliverable)
  ...
  context "when not persisted" do
    ...
    it "should not send email" do
      expect(EventMailer).to_not receive(:decline)
